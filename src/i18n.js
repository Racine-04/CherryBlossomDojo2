...
const resources = {
  en: {
    translation: {
      ...
      areYouSureCreateAccount: "Are you sure you want to create this account with this information?",
      // Login translations
      logInTitle: "Log in",
      ...
      confirmPasswordReset: "Are you sure you want to reset your password?",
      // Initial Videos
      initialVideos: [
        {
          id: 1,
  ...
  es: {
    translation: {
      ...
      confirmPasswordReset: "¿Estás seguro de que quieres restablecer tu contraseña?",
      // Initial Videos
      initialVideos: [
        {
          id: 1,
  ...
  ja: {
    translation: {
      ...
      aboutUs: "私たちに関しては",
      aboutText: [
        "桜道場へようこそ！自宅から武道の世界に浸りましょう。私たちの使命は、武道の規律、強さ、そして静けさを、場所を問わずすべての人々に届けることです。",
        "私たちの経験豊富なインストラクターが、初心者から上級者まで、すべてのレベルに合わせた高品質のチュートリアルを提供します。フィジカルフィットネスを向上させ、メンタルクリアリティを高め、武道の力を通じて全体的な健康を向上させましょう。",
        "桜道場では、武道は単なるワークアウトではなく、ライフスタイルだと考えています。私たちのプログラムは、身体能力を向上させ、精神的な規律を育み、精神的な成長を促進するように設計されています。自己防衛の技術を学びたい、フィットネスを向上させたい、または内なる平和への道を見つけたいと思っているなら、私たちの道場はすべての人に何かを提供します。",
        "私たちは、誰もが成長できるサポートと包括的な環境を提供することに専念しています。私たちのコミュニティに参加し、自己発見、エンパワーメント、変革の旅を始めましょう。桜道場では、あなたはただの道場に参加するのではなく、家族に参加するのです。"
      ],
      tutorials: "チュートリアル",
      tutorialsVideo: "チュートリアルビデオ",
      videoWelcome: "チュートリアルビデオページへようこそ！初心者から上級者まで、あらゆるスキルレベルに合わせた多彩な武道チュートリアルをご覧ください。空手、ムエタイ、ブラジリアン柔術、テコンドー、ボクシング、ブロッキング、ストライキング、ドッジング、スイープなどの基本的な自己防衛技術を含む様々な武道の専門的にキュレーションされたビデオを探求しましょう。スキルを向上させ、新しい技術をマスターし、効果的な自己防衛戦略を見つけるために、私たちのチュートリアルはあなたの目標達成をサポートするように設計されています。左側のフィルターを使用して、武道の種類、スキルレベル、ビデオの長さ、アップロード日で検索をカスタマイズしてください。トレーニングを楽しみ、マスタリーへの旅を楽しんでください！",
      filters: "フィルター",
      martialArts: "武道",
      selfDefense: "自己防衛技術",
      level: "レベル",
      ...
      intermediate: "中級者",
      advanced: "上級者",
      under10Minutes: "10分未満",
      tenTo20Minutes: "10-20分",
      over20Minutes: "20分以上",
      oneWeekAgo: "1週間前",
      twoWeeksAgo: "2週間前",
      oneMonthAgo: "1ヶ月前",
      sixMonthsAgo: "6ヶ月前",
      recommendedVideos: "おすすめのビデオ",
      // Navbar translations
      home: "ホーム",
      about: "私たちに関しては",
      contact: "お問い合わせ",
      planLiveSession: "ライブセッションを計画する",
      logIn: "ログイン",
      signUp: "サインアップ",
      // Footer translations
      contactUs: "お問い合わせ",
      ...
      name: "名前",
      namePlaceholder: "あなたの名前は何ですか？",
      address: "住所",
      addressPlaceholder: "あなたの住所は何ですか？",
      goal: "目標",
      goalPlaceholder: "私たちのプラットフォームでの個人的な目標は何ですか？",
      password: "パスワード",
      ...
      invalidEmailFormat: "無効なメール形式です。例：example@gmail.comのようにしてください。",
      areYouSureCreateAccount: "この情報でアカウントを作成してもよろしいですか？",
      // Login translations
      logInTitle: "ログイン",
      emailOrUsername: "メールアドレス",
      emailOrUsernamePlaceholder: "メールアドレスを入力",
      rememberMe: "私を覚えてますか",
      ...
      goalRequired: "目標は必須です",
      passwordRequired: "パスワードは必須です",
      passwordsDoNotMatch: "パスワードが一致しません",
      fillOutAllFields: "すべてのフィールドに入力してください",
      // Booking
      bookSession: "ライブセッションを計画する",
      selectSensei: "先生を選ぶ",
      selectDate: "日付を選択",
      selectTime: "時間を選択",
      bookNow: "今すぐ予約",
      cancel: "キャンセル",
      bookingConfirmed: "{{sensei}}と{{date}}の{{time}}に予約が確認されました。",
      confirmBooking: "{{sensei}}と{{date}}の{{time}}にこのライブセッションを予約してもよろしいですか？",
      // Password Reset
      resetPasswordTitle: "パスワードをリセット",
      newPassword: "新しいパスワード",
      newPasswordPlaceholder: "新しいパスワードを入力してください",
      resetPassword: "パスワードをリセット",
      confirmPasswordReset: "パスワードをリセットしてもよろしいですか？",
      // Initial Videos
      initialVideos: [
        {
          id: 1,
          title: 'MMA向けの高度なBJJムーブ：トライアングルチョークのチュートリアル',
          type: 'ブラジリアン柔術',
          level: '上級者',
          time: '10-20分',
          date: '1ヶ月前',
        ...
        {
          id: 2,
          title: 'ストライキング技術のマスター：マクレガー対ポワリエのレッスン',
          type: 'ボクシング',
          level: '中級者',
          time: '10-20分',
          date: '2週間前',
        ...
        {
          id: 7,
          title: '効果的なストライキング：ボクシングとキックボクシングのドリル',
          type: 'ストライキング',
          level: '上級者',
          time: '20分以上',
          date: '6ヶ月前',
        ...
        {
          id: 8,
          title: 'ドッジングとウィービング：ファイターのための基本技術',
          type: 'ドッジング',
          level: '中級者',
          time: '10分未満',
          date: '2週間前',
        ...
        {
          id: 16,
          title: 'ストライキングコンビネーション：ムエタイとボクシング',
          type: 'ストライキング',
          level: '中級者',
          time: '20分以上',
          date: '1ヶ月前',
        ...
        {
          id: 20,
          title: 'ムエタイのキックドリル：パワーとスピードのために',
          type: 'ムエタイ',
          level: '上級者',
          time: '20分以上',
          date: '2週間前',
